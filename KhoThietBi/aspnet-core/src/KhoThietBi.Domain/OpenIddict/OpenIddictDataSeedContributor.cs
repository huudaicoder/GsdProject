...
namespace KhoThietBi.OpenIddict;
...
public class OpenIddictDataSeedContributor : IDataSeedContributor, ITransientDependency
{
    ...
    {
        if (await _openIddictScopeRepository.FindByNameAsync("KhoThietBi") == null)
        {
            await _scopeManager.CreateAsync(new OpenIddictScopeDescriptor {
                Name = "KhoThietBi", DisplayName = "KhoThietBi API", Resources = { "KhoThietBi" }
            });
        }
    }
    ...
    private async Task CreateApplicationsAsync()
    {
        ...
        // Swagger Client
        var swaggerClientId = configurationSection["KhoThietBi_Swagger:ClientId"];
        if (!swaggerClientId.IsNullOrWhiteSpace())
        {
            var swaggerRootUrl = configurationSection["KhoThietBi_Swagger:RootUrl"]?.TrimEnd('/');
        ...
        // Angular SPA Client (ROPC — Resource Owner Password Credentials for admin-only internal tool)
        var angularClientId = configurationSection["KhoThietBi_App:ClientId"];
        if (!angularClientId.IsNullOrWhiteSpace())
        {
            var angularClientSecret = configurationSection["KhoThietBi_App:ClientSecret"];
            var angularRootUrl = configurationSection["KhoThietBi_App:RootUrl"]?.TrimEnd('/');
