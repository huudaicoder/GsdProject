...
- [ ] **Phase 1: Admin Login + JWT** — Secure login with session persistence across browser refresh
- [ ] **Phase 2: Audit Trail** — Automatic write-operation logging for all admin actions
- [ ] **Phase 3: Equipment Categories** — Reference data CRUD for equipment categories
- [ ] **Phase 4: Suppliers** — Reference data CRUD for equipment suppliers
- [ ] **Phase 5: Departments** — Reference data CRUD for company departments
- [ ] **Phase 6: Equipment Catalog** — Full equipment CRUD with search, filters, status display, and photo upload
- [ ] **Phase 7: Employee Management** — Employee records linked to departments
- [ ] **Phase 8: Project Management** — Project records for equipment allocation
- [ ] **Phase 9: Import Flow** — Inbound receipts from suppliers with automatic equipment creation
- [ ] **Phase 10: Supplier Payments** — Payment tracking and import receipt history
- [ ] **Phase 11: Employee Assignment** — Assign equipment to employees and record returns
- [ ] **Phase 12: Damage Penalty** — Record damage fines when equipment is returned damaged
- [ ] **Phase 13: Project Allocation** — Allocate equipment to projects and record returns
- [ ] **Phase 14: Maintenance** — Maintenance logs, scheduling, and overdue alerts
- [ ] **Phase 15: Liquidation** — Record equipment disposal and retirement
- [ ] **Phase 16: Financial Summary** — Aggregated financial dashboard (costs, revenue, penalties)
- [ ] **Phase 17: Dashboard** — KPI overview cards for warehouse status at a glance
- [ ] **Phase 18: Reports** — Inventory, history, and department reports
- [ ] **Phase 19: Export** — Excel and PDF export for all reports

---

## Phase Details

### Phase 1: Admin Login + JWT
**Goal**: Admin can securely log in with username/password and their session persists across browser refresh without re-logging in
...
### Phase 2: Audit Trail
**Goal**: Every write operation (create/update/delete) on any entity is automatically recorded in an audit log with who did it, what changed, and when
**Depends on**: Phase 1
**Requirements**: AUTH-03
**Success Criteria** (what must be TRUE):
  1. After any API write operation (POST/PUT/DELETE), an AuditLog record exists with: userId, entity type, entity ID, action type, timestamp, old values (JSON), new values (JSON)
  2. The AuditLog is created atomically within the same database transaction as the write — no separate call needed
  3. Failed operations (rollbacks) do NOT produce orphaned AuditLog entries
**Plans**: TBD
**UI hint**: no
...
**Success Criteria** (what must be TRUE):
  ...
  3. Admin can delete a supplier (no restriction in Phase 4 — import receipt check deferred to Phase 9)
**Plans**: TBD
**UI hint**: yes
...
**Goal**: Admin can assign In-Stock equipment to employees and record their return, with equipment status automatically updating at each step
**Depends on**: Phase 10
**Requirements**: ASNE-01, ASNE-02
**Success Criteria** (what must be TRUE):
...
**Goal**: Admin can record a damage fine when returned equipment is damaged, linking the penalty to the specific assignment
**Depends on**: Phase 11
**Requirements**: ASNE-03
**Success Criteria** (what must be TRUE):
  1. When recording an employee return, admin can optionally record a damage penalty: amount, collection date, damage description
  2. The penalty record is saved and linked to that specific assignment — visible in assignment history
  3. Penalty amount is positive and collection date is required if damage flag is set
**Plans**: TBD
**UI hint**: yes
...
|-------|------|----------------|--------|-----------|
| 1 | Admin Login + JWT | 0/0 | Not started | - |
| 2 | Audit Trail | 0/0 | Not started | - |
| 3 | Equipment Categories | 0/0 | Not started | - |
| 4 | Suppliers | 0/0 | Not started | - |
| 5 | Departments | 0/0 | Not started | - |
| 6 | Equipment Catalog | 0/0 | Not started | - |
| 7 | Employee Management | 0/0 | Not started | - |
| 8 | Project Management | 0/0 | Not started | - |
| 9 | Import Flow | 0/0 | Not started | - |
| 10 | Supplier Payments | 0/0 | Not started | - |
| 11 | Employee Assignment | 0/0 | Not started | - |
| 12 | Damage Penalty | 0/0 | Not started | - |
| 13 | Project Allocation | 0/0 | Not started | - |
| 14 | Maintenance | 0/0 | Not started | - |
| 15 | Liquidation | 0/0 | Not started | - |
| 16 | Financial Summary | 0/0 | Not started | - |
| 17 | Dashboard | 0/0 | Not started | - |
| 18 | Reports | 0/0 | Not started | - |
| 19 | Export | 0/0 | Not started | - |
