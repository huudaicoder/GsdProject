...
- [x] **Phase 1: Admin Login + JWT + Audit** — Secure login, session persistence, ABP audit logging configured
- [ ] **Phase 2: Reference Data — Categories + Suppliers + Departments** — CRUD for equipment categories, suppliers, and departments in a single phase
- [ ] **Phase 3: Equipment Catalog** — Full equipment CRUD with search, filters, status display, and photo upload
- [ ] **Phase 4: Employee Management** — Employee records linked to departments
- [ ] **Phase 5: Project Management** — Project records for equipment allocation
- [ ] **Phase 6: Import Flow** — Inbound receipts from suppliers with automatic equipment creation
- [ ] **Phase 7: Supplier Payments** — Payment tracking and import receipt history
- [ ] **Phase 8: Employee Assignment + Damage Penalty** — Assign equipment to employees, record returns, and record damage fines
- [ ] **Phase 9: Project Allocation** — Allocate equipment to projects and record returns
- [ ] **Phase 10: Maintenance** — Maintenance logs, scheduling, and overdue alerts
- [ ] **Phase 11: Liquidation** — Record equipment disposal and retirement
- [ ] **Phase 12: Financial Summary** — Aggregated financial dashboard (costs, revenue, penalties)
- [ ] **Phase 13: Dashboard** — KPI overview cards for warehouse status at a glance
- [ ] **Phase 14: Reports** — Inventory, history, and department reports
- [ ] **Phase 15: Export** — Excel and PDF export for all reports
...
- [x] 01-02-PLAN.md — Frontend: Angular 19 scaffold + AuthService + login page + app shell + sidebar + dashboard placeholder
**UI hint**: yes

### Phase 2: Reference Data — Categories + Suppliers + Departments
**Goal**: Admin can manage all three reference data types (equipment categories, suppliers, departments) through table UIs with search and modal dialogs
**Depends on**: Phase 1
**Requirements**: EQP-04, SUP-01, EMP-02
**Success Criteria** (what must be TRUE):
  1. Admin can view a paginated, searchable list of categories at /categories and add/edit categories with name (required) and description (optional)
  2. Admin cannot delete a category linked to any equipment — returns error "Không thể xóa danh mục này — đang được sử dụng bởi X thiết bị"
  3. Admin can view a paginated, searchable list of suppliers at /suppliers and add/edit suppliers with name (required), address (optional), contact info (optional)
  4. Admin can view a paginated, searchable list of departments at /departments and add/edit departments with name (required)
  5. Admin cannot delete a department linked to any employee — returns error "Không thể xóa phòng ban này — đang được sử dụng bởi X nhân viên"
**Plans**: TBD
**UI hint**: yes
...
**Success Criteria** (what must be TRUE):
  1. Admin can create an inbound receipt linking a supplier to a list of equipment items with: unit price, quantity, invoice number, receipt date
...
|-------|------|----------------|--------|-----------|
| 1 | Admin Login + JWT + Audit | 2/2 | Complete | 2026-04-16 |
| 2 | Reference Data — Categories + Suppliers + Departments | 0/0 | Not started | - |
| 3 | Equipment Catalog | 0/0 | Not started | - |
| 4 | Employee Management | 0/0 | Not started | - |
| 5 | Project Management | 0/0 | Not started | - |
| 6 | Import Flow | 0/0 | Not started | - |
| 7 | Supplier Payments | 0/0 | Not started | - |
| 8 | Employee Assignment + Damage Penalty | 0/0 | Not started | - |
| 9 | Project Allocation | 0/0 | Not started | - |
| 10 | Maintenance | 0/0 | Not started | - |
| 11 | Liquidation | 0/0 | Not started | - |
| 12 | Financial Summary | 0/0 | Not started | - |
| 13 | Dashboard | 0/0 | Not started | - |
| 14 | Reports | 0/0 | Not started | - |
| 15 | Export | 0/0 | Not started | - |
...
*Restructured: 2026-04-17 — 17 phases → 15 phases (Phase 2+3+4 merged into single Reference Data phase)*
